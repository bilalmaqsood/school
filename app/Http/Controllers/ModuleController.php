...
class ModuleController extends Controller {
	...
	public function getIndex2( Request $request)
	{
        ...
        {
            $rowData = \DB::table('tb_module')->get();
    ...
    function getIndex( $id=NULL )
    {
        ...
        // $this->data['pageTitle']     = "Module Permissions";

        $module = \DB::table('tb_module')->get();        
        $group = \DB::table('tb_group')->get();        
        $access = \DB::table('tb_group_access')->get();        
        if(count($module) <= 0){
             return Redirect::to('/module')->with('messagetext','Can not find module')->with('msgstatus','error');                       
        ...
        // $this->data['modules_name'] = $row->name;
