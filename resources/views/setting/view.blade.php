    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div id='demo-form2' class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Start Date & Time
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ $row->start_datetime }}
                    </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">End Date & Time
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ $row->end_datetime }}
                    </div>
